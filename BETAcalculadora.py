...
def equacionesBiquadradas():
	...
	def pasos(a,b,c):
		...
		f2 = int(len(f1) / 2.5)
		time.sleep(times)
		print("\n\n\t\t{}Se substituye a b c por los numeros corespondientes{}".format(naranja(), white()))
		print("\n\t\t{}\n\t\t{}\n\t\t{}2 · {}".format(f1, "-" * len(f1), " " * f2, a))
		f1 = "{}+-~{}-{}".format(-b, b ** 2, 4 * a * c)
		f2 = int(len(f1) / 2.2)
		time.sleep(times)
...
def opb():
	...
	os.system(comando())
	print(titulos(titol, subtitol, type))
	print("\nPon el primer numero y presiona ENTER")
	a = float(input())

	os.system(comando())
	print(titulos(titol, subtitol, type))
	print("\nPon el signo y presiona ENTER")
	s = input("{} ".format(a))
	
	os.system(comando())
	print(titulos(titol, subtitol, type))
	print("\nPon el segundo numero y presiona ENTER")
	b = float(input("{} {} " .format(a, s)))
...
def rufini():
	...
	print("{}{} {} {} {} {} {}".format(white()," " * (len(str(h)) + 1),a2, b2, c2, d2, e2))
